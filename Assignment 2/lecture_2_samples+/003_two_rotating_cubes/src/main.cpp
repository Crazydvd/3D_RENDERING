...
int main () {
    //Open SFML Window == Valid OpenGL Context, NOTICE THE DEPTH BUFFER SETTINGS!
    sf::RenderWindow window(sf::VideoMode (800, 600), "OpenGL Windo", sf::Style::Default, sf::ContextSettings(24,0,0,3,3));
    ...
    while (window.isOpen()) {
        ...
        glm::mat4 modelMatrix1    (glm::translate (glm::vec3(-1.5,0,-5)) * glm::rotate (clock()/1000.0f, glm::vec3(0.7,0.7,0.7)));

        glUniformMatrix4fv (glGetUniformLocation (programID, "mvpMatrix"), 1, GL_FALSE, glm::value_ptr(vp*modelMatrix1));
        glDrawArrays( GL_TRIANGLES, 0, 36);

        glm::mat4 modelMatrix2    (glm::translate (glm::vec3(1.5,0,-5)) * glm::rotate (clock()/1000.0f, glm::vec3(0.7,-0.7,0.0)));
